...
def search_and_download(search_term: str, target_path='./images/url_images', number_images=10):
...
# search_term = 'https://www.google.com/search?q=images+modi&rlz=1C1CHBF_enIN1005IN1005&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjd6e-wx_D6AhUfTWwGHRPCDkkQ_AUoAXoECAMQAw&biw=1536&bih=714&dpr=1.25'
